...
public class BluetoothConnection2 extends Activity {
    Button btnOn, btnOff;
    TextView txtArduino, txtString, txtStringLength, temperature, pressure, oilevel, sensorView3;
    Handler bluetoothIn;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        pressure = (TextView) findViewById(R.id.sensorView1);
        oilevel = (TextView) findViewById(R.id.sensorView2);
                ...
                if (msg.what == handlerState) {                                     //if message is what we want
                    ...
                    if (endOfLineIndex > 0) {                                           // make sure there data before ~
                       ...
                       // txtStringLength.setText("String Length = " + String.valueOf(dataLength));
                        ...
                        {
                            String sensor0 = recDataString.substring(1,20 );             //get sensor value from string between indices 1-5
                            String sensor1 = recDataString.substring(21, 40);            //same again...
                            String sensor2 = recDataString.substring(41, 60);
                           // String sensor3 = recDataString.substring(16, 20);

                            temperature.setText( sensor0 );    //update the textviews with sensor values
                            pressure.setText( sensor1 );
                            oilevel.setText( sensor2 );
